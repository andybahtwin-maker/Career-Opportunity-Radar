...
This project uses only Python standard library modules and local JSON files. It does need outbound internet access when running `--json`, `scan`, or `validate` because it checks public career pages and ATS APIs.
