...
Scoring is rule-based and transparent. The current ranking is local-first: realistic Denver metro, construction, building-materials, interiors, showroom, design-sales, contractor-facing, stable-pay, vehicle/reimbursement, and customer-workflow signals outrank generic remote SaaS keyword matches. Physical-industry software tied to construction, AEC, field operations, contractor workflow, homebuilding, facilities, manufacturing, geospatial, or reality capture remains a secondary fit lane. Negative signals suppress non-Denver market or territory restrictions, enterprise-only/strategic/title-inflated SaaS matches, generic remote SaaS without physical-industry context, SDR/BDR-only work, commission-only, unsupported personal-vehicle requirements, heavy travel, and unrelated technical roles.

Every rescored job carries a practical-fit label such as `Strong Local Fit`, `Strong Construction/Design Sales Fit`, `Realistic Local Sales Fit`, `Realistic Local Design/Technical Fit`, `Strong Construction Tech Fit`, `Remote Physical-Industry Stretch`, `Side-Cash Contractor`, `Realistic Stretch`, `Remote Stretch`, `Semantic Match Only`, `Likely ATS Reject`, `Vehicle Barrier`, `Commission-Only Risk`, or `Not a Fit`. The Jobs / Radar cards, Markdown digest, and JSON top opportunities show those labels plus warning reasons when a role is a non-Denver territory, senior/enterprise stretch, generic remote SaaS match, remote stretch, vehicle barrier, commission-only risk, or already applied. Remote physical-industry software roles can remain visible when their workflow context is credible, while paid remote contractor tasks stay below the core career lanes.
